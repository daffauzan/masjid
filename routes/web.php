...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::prefix('konten')->name('konten.')->group(function () {
        ...
        Route::get('/', [AdminKontenController::class, 'index'])
            ->name('index');

        Route::get('/create', [AdminKontenController::class, 'create'])
            ->name('create');

        Route::post('/', [AdminKontenController::class, 'store'])
            ->name('store');

        Route::get('/{id}/edit', [AdminKontenController::class, 'edit'])
            ->name('edit');

        Route::put('/{id}', [AdminKontenController::class, 'update'])
            ->name('update');
    });
