...
<head>
    ...
    <meta name="description" content="Halaman registrasi user Masjid Abaabil">
    <meta name="author" content="Masjid Abaabil">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="{{ route('admin.login') }}">Sudah punya akun? Login</a>
                            </div>
                        </div>
                    </div>
                </div>
